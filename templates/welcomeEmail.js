module.exports = (title, text, contact) => {
  return `
  <!doctype html>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                      ...
                      <div
                        style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
                        <p style="text-align: center;">Mail: ${contact.mail}</p>
                        <p style="text-align: center;">Instagram: ${contact.instagram}</p>
                        <p style="text-align: center;">Facebook: ${contact.facebook}</p>
                        <p style="text-align: center;">Teléfono de contacto: ${contact.phone}</p>
                      </div>
